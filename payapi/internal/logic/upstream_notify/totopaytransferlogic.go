...
type TotopayTransferLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewTotopayTransferLogic(ctx context.Context, svcCtx *svc.ServiceContext) TotopayTransferLogic {
	return TotopayTransferLogic{
...
func (l *TotopayTransferLogic) TotopayTransfer(body []byte) error {
	var reqData struct {
	...
	// 上游和平台金额都以分为单位
	if strconv.FormatInt(order.ReqAmount, 10) != reqData.Amount {
