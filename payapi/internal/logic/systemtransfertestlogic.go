...
type SystemTransferTestLogic struct {
	logx.Logger
	ctx      context.Context
...
func NewSystemTransferTestLogic(ctx context.Context, svcCtx *svc.ServiceContext, merchant *model.Merchant) SystemTransferTestLogic {
	return SystemTransferTestLogic{
...
func (l *SystemTransferTestLogic) VerifyParam(req types.SystemTransferTestReq) error {
	if req.Amount < 1 {
...
func (l *SystemTransferTestLogic) SystemTransferTest(req types.SystemTransferTestReq) (*types.SystemTransferTestReply, error) {
	// 1.参数验证
	...
	// 3.返回给下游
	return &types.SystemTransferTestReply{
