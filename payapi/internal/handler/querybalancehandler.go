...
func QueryBalanceHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QueryBalanceReq
		...
		// 验证请求参数
		l := logic.NewQueryBalanceLogic(r.Context(), ctx, merchant)
		resp, err := l.QueryBalance(req)
		if err != nil {
			httpx.Error(w, err)
		} else {
