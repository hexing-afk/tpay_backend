...
func SystemTransferHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SystemTransferReq
		...
		l := logic.NewSystemTransferLogic(r.Context(), ctx, merchant)
		resp, err := l.SystemTransfer(req)
		if err != nil {
			httpx.Error(w, err)
		} else {
