...
func TransferOrderQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TransferOrderQueryReq
		...
		l := logic.NewTransferOrderQueryLogic(r.Context(), ctx, merchant)
		resp, err := l.TransferOrderQuery(req)
		if err != nil {
			httpx.Error(w, err)
		} else {
