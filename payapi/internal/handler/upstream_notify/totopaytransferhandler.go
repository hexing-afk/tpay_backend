...
func TotopayTransferHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		logx.Infof("totopay-notify-transfer-body:%v", string(body))

		l := upstream_notify.NewTotopayTransferLogic(r.Context(), ctx)
		if err := l.TotopayTransfer(body); err != nil {
