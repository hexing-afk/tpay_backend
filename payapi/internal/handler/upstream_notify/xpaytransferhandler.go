...
func XPayTransferHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		logx.Infof("xpay-notify-transfer:%+v", req)

		l := logic.NewXPayTransferLogic(r.Context(), ctx)
		err := l.XPayTransfer(req)
		if err != nil {
