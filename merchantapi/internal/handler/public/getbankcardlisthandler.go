...
func GetBankCardListHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetBankCardListRequest
		...
		l := logic.NewGetBankCardListLogic(r.Context(), ctx)
		resp, err := l.GetBankCardList(userId, req)
		if err != nil {
			httpx.Error(w, err)
		} else {
