...
func UpdateBankCardHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateBankCardRequest
		...
		l := logic.NewUpdateBankCardLogic(r.Context(), ctx)
		err := l.UpdateBankCard(userId, req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			common.OkJson(w, nil)
