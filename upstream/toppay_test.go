...
func GetTopPayObj() Upstream {
	jsonStr := `{
		"Host": "http://127.0.0.1:23331"
	}`
	obj, err := NewTopPay("", jsonStr)
	if err != nil {
...
func TestTopPayPay_QPaySign(t *testing.T) {
	up := GetTopPayObj()
	...
	resp, err := up.(*TopPay).QPaySign(req)
	if err != nil {
		t.Errorf("err=%v", err)
		return
	}
...
func TestTopPayPay_PayOrderQuery(t *testing.T) {
	up := GetTopPayObj()
...
func TestTopPayPay_Transfer(t *testing.T) {
	up := GetTopPayObj()
...
func TestTopPayPay_TransferOrderQuery(t *testing.T) {
	up := GetTopPayObj()
...
func TestTopPayPay_TransferOrderQuery2(t *testing.T) {
...
func TestTopPayPay_Sign(t *testing.T) {
...
func TestTopPayPay_CheckSign(t *testing.T) {
	...
	//if reqData.IsCancel == TopPayCancelled {
