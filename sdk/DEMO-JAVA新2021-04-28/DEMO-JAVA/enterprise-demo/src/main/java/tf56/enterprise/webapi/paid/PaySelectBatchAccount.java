 ...
 * updateDate:20180507
 */
public class PaySelectBatchAccount {

	private final static Logger logger = LoggerFactory.getLogger(PaySelectBatchAccount.class);

	private final static String charset = "UTF-8";

	private static void params1(Map<String, Object> map) {
		map.put("service_id", "tf56enterprise.batchPay.queryPayToAccount");
		map.put("appid", PaidEnity.getAppid());
		map.put("tf_timestamp", PaidEnity.getTfTimestamp());
		map.put("batchno", "20180507");//被查询批次号
		map.put("terminal", "PC");
		map.put("batchno", "20180507");
	}
