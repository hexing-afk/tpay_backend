...
import tf56.enterprise.demo.constant.IgnoreKeySet;
...
public class ParamUtil {
	...
	public static String map2MD5(Map<String, Object> map) throws Exception {
		...
		System.out.println("tf-sign:"+keyString);
	...
	/**
	 * 参数按ansc码升序排列后key1=value1&key2=value2
	 * 
	 * @param map
	 * @return
	 * @throws Exception
	...
	public static String map2MapAndValueBydesc(Map<String, Object> map) throws Exception {
		...
		String keyString = sb.toString();
		System.out.println("排序信息:"+keyString);
		return keyString;
	}
