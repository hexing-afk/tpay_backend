...
func ModifyUpstreamChannelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ModifyUpstreamChannelRequest
		...
		l := logic.NewModifyUpstreamChannelLogic(r.Context(), ctx)
		err := l.ModifyUpstreamChannel(req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			common.OkJson(w, nil)
