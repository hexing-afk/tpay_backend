...
func ModifyAdminPasswordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ModifyAdminPasswordRequest
		...
		l := logic.NewModifyAdminPasswordLogic(r.Context(), ctx)
		err = l.ModifyAdminPassword(userId, req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			common.OkJson(w, nil)
